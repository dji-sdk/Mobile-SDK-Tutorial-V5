...
> **Note:**
>
> * The Android Studio version used in this guide is Android Studio Chipmunk 2021.2.1 Patch 1, the MSDK version is 5.3.0 and the UXSDK package is compatible with MSDK 5.3.0
> * **Android Gradle Plugin version is 4.2.2**
> * Android version is only supported from 23 to 29, recommended Kotlin version is 1.6.10, recommended Gradle version is 6.9
