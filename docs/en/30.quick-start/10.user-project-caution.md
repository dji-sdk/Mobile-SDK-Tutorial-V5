This instruction introduces how to integrate the MSDK package and UXSDK open-source framework from the MSDK V5 Sample to an empty project. In this instruction, the version of the Android Studio is Android Studio Bumblebee 2021.1.1, and the version of the MSDK is 5.1.0. Users need to follow or check the below instructions based on your software version.
