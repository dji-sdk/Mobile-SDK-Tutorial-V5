...
#### ISDKManager
ISDKManager is the entrance management class. Compared with 4.X, it makes some simpilification. Please refer to [Quick Start](https://developer.dji.com/doc/mobile-sdk-tutorial/en/quick-start/run-sample.html) to understand the registration, setting, App Key application and how to use the sample code.
