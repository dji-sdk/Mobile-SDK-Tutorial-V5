...
> 2. MSDK 5.X currently only supports: DJI Mavic 3M (M3M), DJI Mavic 3 Enterprise Series (M3E/M3T), Matrice 30 Series (M30/M30T) and Matrice 300 RTK (M300 RTK), and will only supports some of the new DJI products in the future.
