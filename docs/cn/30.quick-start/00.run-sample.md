本指引中使用的 Android Studio 版本为 **Android Studio Giraffe 2024.1.1**，适配的 MSDK 为最新版本。可以预先阅读 MSDK Sample 工程的 [Readme 文件](https://github.com/dji-sdk/Mobile-SDK-Android-V5/blob/dev-sdk-main/README_CN.md) 熟悉 Sample 工程。
