...
> 2. MSDK 5.X 目前支持机型查看[版本发布](https://developer.dji.com/doc/mobile-sdk-tutorial/cn/)中的“支持产品列表和固件版本”，且未来只计划支持部分DJI的新机型。
...
#### ISDKManager
ISDKManager为MSDK入口管理类，相对于4.X做了简化。请参考[快速入门](https://developer.dji.com/doc/mobile-sdk-tutorial/cn/quick-start/run-sample.html)，熟悉注册、配置、APP_Key申请以及示例代码的使用。 
